...
import { nifty50Stocks, nifty200, indices, sectoralIndices, commodities } from '../data/assets';
            ...
            <div className="relative">
              ...
              >
                ...
                <optgroup label="Nifty 50">
                 ...
                 <optgroup label="Nifty 200">
                  {nifty200.map(stock => (
                    <option key={stock.symbol} value={stock.symbol}>{stock.name}</option>
                  ))}
                </optgroup>
                <optgroup label="Indian Sectoral Indices">
                  {sectoralIndices.map(index => (
